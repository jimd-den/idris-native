...
;; @generated by Idris 0.8.0-ed88eddb1, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define DataC-45Buffer-prim__setBits64 (lambda (farg-0 farg-1 farg-2 farg-3) (blodwen-buffer-setbits64 farg-0 farg-1 farg-2)))
(define DataC-45Buffer-prim__newBuffer (lambda (farg-0 farg-1) (blodwen-new-buffer farg-0)))
(define DataC-45Buffer-prim__getBits64 (lambda (farg-0 farg-1 farg-2) (blodwen-buffer-getbits64 farg-0 farg-1)))
...
(define Main-sha256_verify (lambda (arg-0 arg-1 ext-0) (let ((act-1 ((DataC-45Buffer-newBuffer (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8912) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8912 eta-0)))))) (lambda (u--a) (lambda (arg-9951) (lambda (eta-0) arg-9951))) (lambda (u--b) (lambda (u--a) (lambda (arg-9957) (lambda (arg-9964) (lambda (world-4) (let ((act-5 (arg-9957 world-4))) (let ((act-3 (arg-9964 world-4))) (act-5 act-3))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10436) (lambda (arg-10439) (lambda (world-0) (let ((act-1 (arg-10436 world-0))) ((arg-10439 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10450) (lambda (world-0) (let ((act-1 (arg-10450 world-0))) (act-1 world-0)))))) (lambda (u--a) (lambda (arg-13044) arg-13044))) 64) ext-0))) (if (null? act-1) 0 (let ((e-1 (unbox act-1))) (let ((act-2 (DataC-45Buffer-prim__setBits64 e-1 16 (bu+ (blodwen-bits-shl (blodwen-and (blodwen-xor arg-0 arg-1) (blodwen-or arg-0 arg-1)) 2 64) (blodwen-xor 18446744073709551615 arg-0) 64) ext-0))) (DataC-45Buffer-prim__getBits64 e-1 16 ext-0)))))))
...
(define Main-main (lambda (ext-0) (let ((act-1 (Main-sha256_verify 2 2 ext-0))) (PreludeC-45IO-prim__putStr (string-append (PreludeC-45Show-u--show_Show_Bits64 act-1) "\xa;") ext-0))))
